...
std::string Random_t::nstring(unsigned x, unsigned y) {
...
std::string Random_t::astring(int x, int y) {
...
std::string Random_t::cLastName(int rNum) {
    std::string res;
    res.reserve(15);
    std::array<std::string, 10> subStrings{{"BAR", "OUGHT", "ABLE", "PRI", "PRES", "ESE", "ANTI", "CALLY", "ATION", "EING"}};
    for (int i = 0; i < 3; ++i) {
